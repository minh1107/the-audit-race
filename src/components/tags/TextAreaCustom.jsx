...
const TextAreaCustom = ({number, text, required, name, placeholder}) => {
  return (
    <div className='flex flex-col gap-[1vw]'>   
        ...
        <Field className="input-custom w-full border-[0.0625vw] outline-none bg-transparent 
        text-[#8C77B9] border-x-0 border-t-0 border-b-[#493BA1] text-[1vw] leading-[1.5vw] font-normal h-[6.5625vw] mb-[1.19vw]
