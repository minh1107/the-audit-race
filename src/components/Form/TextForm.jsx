...
const TextForm = ({text, marginBottom=true}) => {
  return (
    <div className={`flex ${marginBottom ? "mb-[3vw]" : ''} items-center max-md:items-start`}>
        ...
        <h2 className='form-register__title2 font-exoFont -translate-x-[2vw] max-md:translate-x-[-5vw]'>{text}</h2>
    </div>
  )
}
