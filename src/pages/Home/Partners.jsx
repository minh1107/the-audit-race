...
{title: 'Nhà tài trợ bạch kim', partner: [{title:'SAPP',src:'/update/sap.png'}]},
...
{title: 'Bảo trợ truyền thông', partner: [{title:'AdSangTao',src:'/adsangtao.png'}, 
{title: 'Esight',src:'/esight.png'}, {title:'Ybox',src:'/ybox.png'}, 
{title:'Edu2Review',src:'/edu2review.png'}]},
{title: 'Bảo trợ hình ảnh', partner: [{title:'ynm_logo',src:'/ynm_logo.jpg'}]},
{title: 'Đối tác truyền thông', partner: [{title:'A_A_aof',src:'/A_A_aof.png'}, 
{title: 'AAC_thăng_long',src:'/AAC_thăng_long.png'}, {title:'afc_ptit',src:'/afc_ptit.jpg'}, 
  ...
  return (
    <div className='relative w-full pt-[5.625vw] pb-[17.625vw] px-[6.25vw] mt-[-0.1vw] max-md:pl-[6.25vw] max-md:pr-0 max-md:pt-[17.8vw] max-md:mt-[-0.7vw]' id='doitac'>
        ...
        <div className='flex justify-between max-md:pr-[6.25vw]'>
            {/* <h2>Thể lệ</h2>
            <div>Icon</div> */}
            <Image data-aos="fade-up" src={partnerTitle} alt='partners__title' width={359} height={143} className='w-[22.4375vw] max-md:w-[42.9vw]'></Image>
        ...
        <div className='mt-[9.3125vw] flex flex-col gap-[4.5vw]'>
            {data.map((item, index) => (
                <div key={index} className='pb-[0.5vw] border-b border-solid border-[#493BA1] max-md:pb-[1vw]'>
                    <h2 data-aos="fade-up" className='font-exoFont text-[1.5vw] font-bold leading-[2.25] text-[#FFC6FD] uppercase max-md:text-[3.7vw]'>{item.title}</h2>
                    <div data-aos="fade-up" className='flex gap-[2vw] mt-[1.5vw] max-md:mt-[3.4vw] max-md:flex-nowrap max-md:gap-[6vw] max-md:overflow-scroll whitespace-nowrap'>
                    {item.partner.map((itm, indx) => (
                        <div data-aos="fade-up" key={indx} className='max-md:flex-shrink-0'> 
                            ...
                            ${index === 0 && indx === 1 ? 'scale-100 bg-white h-[4.1875vw]' : ''}
                            ${index === 8 ? 'scale-100 bg-white h-[4.1875vw]' : ''}
                            `}></Image>
                        </div>
                    ))}
                    </div>
