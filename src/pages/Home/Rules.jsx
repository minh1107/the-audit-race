...
const data = [
  ...
  {subtitle: 'Pitching & Debate (29/10)', description:'<p>Các đội sẽ thuyết trình phần Giải Case Study, tranh biện với nhau và trả lời câu hỏi từ Ban Giám khảo.</p>'}] , goal:'Kết thúc vòng 3, 06 thí sinh xuất sắc nhất sẽ bước vào Vòng 4 - Đêm Chung kết.'},
