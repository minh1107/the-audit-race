...
const data = [
  {
    ...
    detail: [
      {
        subtitle: "Thí sinh điền đơn đăng ký thông qua Website của cuộc thi. ",
        description: "",
      },
    ],
    goal: "Thông qua đơn đăng ký, BTC sẽ lựa chọn Top 200 thí sinh phù hợp để bước vào Vòng 2.",
  },
  {
    timeline: "ENTER THE FAST LANE",
    date: "21/10 - 22/10",
    title: "Test offline",
    detail: [
      {
        subtitle:
          "Thí sinh thực hiện bài kiểm tra cá nhân bao gồm 40 câu hỏi trong vòng 60 phút. Nội dung bài kiểm tra gồm các kiến thức: ",
        description:
          '<ul style="display:flex; flex-direction: column; gap: 0.5vw"><li style="border-bottom: 1px solid #0058A9;">KẾ TOÁN (KẾ TOÁN TÀI CHÍNH, KẾ TOÁN QUẢN TRỊ)</li><li style="border-bottom: 1px solid #0058A9">KIỂM TOÁN</li><li style="border-bottom: 1px solid #0058A9">THUẾ</li><li style="border-bottom: 1px solid #0058A9">IQ (HÌNH HỌC, SỐ HỌC, TƯ DUY NGÔN NGỮ,...)</li><li style="border-bottom: 1px solid #0058A9">KIẾN THỨC KINH TẾ XÃ HỘI</li></ul><p style="margin-top: 0.5vw">*Bài kiểm tra hoàn toàn bằng tiếng Anh.</p>',
      },
    ],
    goal: "30 thí sinh xuất sắc nhất sẽ tiếp tục đồng hành cùng cuộc thi.",
  },
  {
    timeline: "ACCELERATION",
    date: "28/10 - 05/11",
    title: "Thử thách case study",
    detail: [
      {
        subtitle: "Training & Networking (29/10)",
        description:
          "<p>Top 30 thí sinh xuất sắc nhất sẽ được tham gia buổi Training & Networking để được bồi dưỡng các kiến thức chuyên môn giúp ích cho việc giải case study Vòng 3 và gặp gỡ, làm quen các đồng đội và Mentor.</p>",
      },
      {
        subtitle: "Giải Case Study",
        description:
          '<p style="margin-top: 1vw">30 thí sinh sẽ được chia thành 6 đội, mỗi đội sẽ có 05 thành viên và thực hiện giải một case study về Kiểm toán trong vòng 3 ngày dưới sự tư vấn của các Mentor - các Senior trong các Công ty Kiểm toán lớn.</p>',
      },
      {
...
const Rules = () => {
  return (
    <div
      className="rules relative w-full pt-[5.625vw] pb-[17.625vw] mt-[-0.1vw] max-md:pt-[14.6vw]"
      id="thele"
    >
      <Image
        fill
      ...
      <div className="flex justify-between px-[6.25vw]">
        <Image
          ...
          width={359}
          height={143}
          className="w-[22.4375vw] max-md:hidden"
        ></Image>
        <svg
        ...
        <Image
          ...
          width={328.9}
          height={65.55}
          className="w-[20.55625vw] max-md:hidden"
        ></Image>
      </div>
      <div className="py-[13.9375vw] relative max-md:py-[10.4vw] max-md:pb-[38.4vw]">
            ...
            <div className="flex gap-[2.1875vw] max-md:gap-0" key={index}>
              <div className="uppercase text-[3vw] font-bold leading-[1.5] text__stroke text-right w-[28.875vw] h-[14.5vw] flex justify-end items-end font-exoFont flex-grow max-md:w-[11.2vw]">
                <h3
                  className={
                    index === 0
                      ? "w-[13.375vw] max-md:hidden"
                      : "w-[21.875vw] max-md:hidden"
                  }
                >
                  {item.timeline}
                </h3>
              ...
              <div className="pl-[12.6875vw] pr-[29.375vw] relative w-[69.9375vw] max-md:pr-[12.4vw] max-md:w-[88.8vw] max-md:pl-[15.4vw]">
                <div className="flex flex-col">
                  <span className="text-[1.25vw] text__gradient2 leading-[1.5] tracking-[0.03px] font-bold max-md:text-[3.2vw]">
                    {item.date}
                  </span>
                  <h4 className="text__gradient2 text-[2.25vw] font-bold leading-[1.5] uppercase font-exoFont max-md:text-[5.2vw] max-md:whitespace-nowrap">
                    {item.title}
                  </h4>
                </div>
                <div>
                  <div className="mt-[5.875vw] max-md:mt-[6.4vw] flex flex-col gap-[2vw]">
                    {item.detail.map((itm, indx) => (
                      <div key={indx} className="">
                        <h5 className="text-[#E3F7FF] max-md:text-[3.2vw]">
                          {itm.subtitle}
                        </h5>
                        <div
                          dangerouslySetInnerHTML={{ __html: itm.description }}
                          className="text-[#A4DEFF] text-[1vw] leading-[1.5] tracking-[-0.08px] mt-[1.5vw] max-md:text-[2.6vw] max-md:mt-[3.7vw]"
                        ></div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="flex gap-[0.75vw] mt-[2vw] max-md:gap-[1.5vw] max-md:mt-[4.8vw]">
                  <Image
                    ...
                    width={35.92}
                    height={18.27}
                    className="w-[2.245vw] max-md:w-[5vw]"
                  ></Image>
                  <span className="text-[#E3F7FF] text-[1.25vw] leading-[1.5] tracking-[0.03px] font-bold max-md:text-[3.2vw] max-md:font-medium justify-evenly">
                    {" "}
                    {item.goal}{" "}
                  </span>
                </div>
                <Image
                  ...
                  src={lineListImg}
                  alt="line__list"
                  className="absolute top-[1.5vw] left-0 w-[25.25vw] max-md:hidden"
                ></Image>
                <Image
                  width={404.79}
                  height={186.5}
                  src={lineListMb}
                  alt="line__list"
                  className="hidden absolute w-[27.7vw] top-[8.5vw] left-0 w-[25.25vw] max-md:block"
                ></Image>
              </div>
            </div>
          ))}
        ...
        <div
          className="absolute top-0 left-[30.4vw] w-[0.0625vw] h-full max-md:w-[0.26vw] max-md:left-[12.5vw] z-[-1]"
          style={{
            background:
              "linear-gradient(92deg, #F07DED 0.27%, #EC4AE7 51.91%, #F281EF 99.31%)",
          }}
        ></div>
        <div
          className="absolute top-[2.1vw] left-[22.775vw] w-[19.3125vw] h-[15.25vw] rotate-90 max-md:left-[6.5vw]"
          style={{
            background:
              "linear-gradient(90deg, #01026D 0%, rgba(1, 2, 109, 0.00) 104.94%)",
          }}
        ></div>
        <Image
          width={404.79}
          ...
          src={lineListMb}
          alt="line__list"
          className="hidden absolute w-[27.7vw] bottom-[0] left-[11.2vw] w-[25.25vw] max-md:block"
        ></Image>
      </div>
      <div className="flex items-center gap-[3.6875vw] pl-[21.375vw] pr-[20.3vw] mt-[-1.2vw] max-md:mt-[-23vw] max-md:pl-[26.6vw] max-md:pr-[12.4vw]">
        <Image
          ...
          src={rulesLogo}
          alt="rules__logo"
          className="w-[18.85vw] max-md:hidden"
        ></Image>
        <div className="flex flex-col">
          <div className="flex gap-[1.5625vw] items-center">
            <h3
              className="text__gradient2 font-exoFont font-bold leading-[1.5] text-[3vw] uppercase max-md:text-[6.4vw]"
              style={{
                textShadow:
                  "0px 0px 0.5625vw #EC4AE7, 0px 0px 0.1875vw #FA75F6",
              }}
            >
              {" "}
              Chung kết{" "}
            </h3>
            <span className="text-white text-[2.25vw] leading-[1.5] font-bold font-exoFont max-md:text-[6.4vw]">
              {" "}
              17/11{" "}
            </span>
            <Image
              ...
              src={barImg}
              alt="bar"
              className="w-[9.54vw] max-md:hidden"
            ></Image>
          </div>
          <div
            className="text__stroke py-[1.1875vw] border-t border-b border-solid border-[#C4C4C4] mt-[1.375vw] text-[3.5625vw] font-bold font-exoFont max-md:hidden"
            style={{
              textShadow:
                "0px 0px 0.5625vw #EC4AE7, 0px 0px 0.1875vw #FA75F6, 0.125vw 0.25vw 0.25vw rgba(0, 0, 0, 0.40)",
            }}
          >
            VELOCITY UNLEASH
          </div>
          <span className="text-[#E3F7FF] text-[1.25vw] leading-[1.5] tracking-[0.03px] mt-[1.375vw] max-md:text-[3.2vw] max-md:mt-[5.3vw]">
            {" "}
            Top 06 thí sinh được chia làm 2 đội, mỗi đội 03 thí sinh. Mỗi đội
            thi sẽ có 2 ngày để giải Case Study đã cho trước{" "}
          </span>
        </div>
      </div>
    </div>
