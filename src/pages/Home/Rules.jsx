...
const data = [
  ...
  {timeline: 'ACCELERATION',date: '28/10 - 05/11', title: 'Thử thách casestudy', detail: 
  [{subtitle: 'Training & Networking (29/10)', 
  description:'<p>Top 30 thí sinh xuất sắc nhất sẽ được tham gia buổi Training & Networking để được bồi dưỡng các kiến thức chuyên môn giúp ích cho việc giải casestudy Vòng 3 và gặp gỡ, làm quen các đồng đội và Mentor.</p>'}, 
  ...
  {subtitle: 'Pitching & Debate (05/10)', description:'<p>Các đội sẽ thuyết trình phần Giải Case Study, tranh biện với nhau và trả lời câu hỏi từ Ban Giám khảo.</p>'}] , goal:'Kết thúc vòng 3, 06 thí sinh xuất sắc nhất sẽ bước vào Vòng 4 - Đêm Chung kết.'},
