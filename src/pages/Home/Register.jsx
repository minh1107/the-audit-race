...
const Registers = () => {
  return (
    <div className='relative w-full pt-[5.625vw] pb-[18.5vw] pr-[6.25vw] pl-[13.9375vw] mt-[-0.1vw] z-40 max-md:px-[5.3vw] max-md:pt-[11.2vw] max-md:pb-[104.5vw]'>
        ...
        <Image fill src={cupImg} alt='partner__bg' className='hidden absolute max-md:translate-y-[20%]
         translate-x-[-5%] max-md:top-[46%] cupImg h-[78%] max-md:left-[-42px] object-contain z-[-1] max-md:block'></Image>
        ...
        <div className='flex flex-col items-start mt-[5.8125vw] max-md:items-center max-md:mt-[-7vw]'>
            ...
            <Link href='/form-register'><button className='py-[0.875vw] px-[2.5625vw] border border-solid bodder-[#FFDBC7] rounded-[1.6875vw] font-exoFont text-[1vw] font-bold leading-[1.5] mt-[2vw] text-[#FFF8FF] uppercase max-md:text-[2.6vw] max-md:mt-[5.8vw] max-md:py-[2.1vw] max-md:px-[6.3vw] rounded-[4vw]' style={{background:'linear-gradient(92deg, #F07DED 0.27%, #EC4AE7 51.91%, #F281EF 99.31%)', boxShadow:'0px 0px 36px 0px rgba(223, 97, 255, 0.38), 0px 0px 11px 0px rgba(255, 97, 239, 0.33), 0px 0px 75px 0px rgba(233, 97, 255, 0.59), 0px 0px 18px 0px rgba(252, 97, 255, 0.06), 0px 0px 20px 0px rgba(228, 57, 183, 0.20)'}}> Đăng ký dự thi </button></Link>
        </div>
    </div>
  )
}
