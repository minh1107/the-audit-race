...
const FinalRules = () => {
  return (
    <div className='relative w-full pt-[4.1875vw] px-[5.9375vw] pb-[19.4375vw] mt-[-0.2vw] max-md:px-[2.6vw] max-md:pb-[86.6vw] max-md:mt-[-1vw]'>
        ...
        <div className='flex max-md:flex-col'>
            {data.map((item, index) => (
                <div className={`py-[5.25vw] px-[4.3125vw] relative w-[29.75vw] ${index!==0 ? 'ml-[-1vw] max-md:ml-0 max-md:mt-[-5vw]' : 'ml-0'} ${index===0 && 'mt-[12vw]'} ${index===1 && 'mt-[6vw]'} max-md:w-full max-md:py-[16.8vw] max-md:px-[13.8vw]`} key={index}>
                    ...
                    <div dangerouslySetInnerHTML={{__html: item.description}} className='text-[#A4DEFF] text-[1vw] leading-[1.5] tracking-[-0.08px] max-md:text-[3.2vw] max-md:mt-[3.2vw]'></div>
                    <div className='flex gap-[0.75vw] mt-[1.9375vw] max-md:gap-[2.1vw] max-md:mt-[5.6vw]'>
                        ...
                        <div dangerouslySetInnerHTML={{__html: item.goal}} className='flex flex-col gap-[1vw] text-[#FFF8FF] w-[27.875vw] max-md:text-[3.2vw] max-md:w-[94.44vw]'>
