...
const data = [
  {timeline: 'first launch',date: '28/09 - 15/10', title: 'Mở đơn', subtitle: 'Thí sinh điền đơn đăng ký thông qua Website của cuộc thi. ', description:'' , goal:'30 thí sinh xuất sắc nhất sẽ tiếp tục đồng hành cùng Cuộc thi.'},
  ...
  return (
    <div className='relative px-[6.25vw] pt-[7.8125vw] pb-[8.875vw] mt-[-0.1vw] max-md:mt-[-0.7vw] z-51' id="giaithuong">
        ...
        <div className='flex flex-col items-center'>
            ...
            <div className='rounded-[0.5vw] relative border w-[27.9vw] pt-[8.4375vw] mt-[3vw] flex flex-col items-center max-md:w-full max-md:pt-[26.1vw] max-md:rounded-[1.5vw] max-md:order-3 max-md:z-[3]' style={{background: 'linear-gradient(180deg, rgba(255, 158, 252, 0.30) 0%, rgba(255, 158, 252, 0.00) 100%)'}}>
                ...
                <ul data-aos="fade-up" className='text-[#A4DEFF] px-[2.3125vw] list-disc mt-[1.8125vw] text-[0.875vw] h-[20vw] overflow-hidden flex flex-col gap-y-[0.5vw] gap-x-[3vw] max-md:text-[2.6vw] max-md:gap-[1.6vw] max-md:h-[30vw] max-md:mt-[5.8vw] max-md:px-[6.9vw]'>
                    ...
                    <li>
                        <b></b>Cơ hội trở thành thực tập sinh chính thức tại <bold className="font-bold">Grant Thornton Vietnam</bold>
                    </li>
                    <li>
            ...
            <div className='rounded-[0.5vw] relative border w-[27.9vw] pt-[8.4375vw] flex flex-col items-center max-md:order-2 max-md:w-full max-md:pt-[26.1vw] max-md:rounded-[1.5vw] max-md:z-[4]' style={{background: 'linear-gradient(180deg, rgba(255, 158, 252, 0.30) 0%, rgba(255, 158, 252, 0.00) 100%)'}}>
                ...
                <ul data-aos="fade-up" className='text-[#A4DEFF] px-[2.3125vw] list-disc mt-[1.8125vw] text-[0.875vw] h-[20vw] overflow-hidden flex flex-col gap-[0.5vw] max-md:text-[2.6vw] max-md:gap-[1.6vw] max-md:h-[30vw] max-md:mt-[5.8vw] max-md:px-[6.9vw]'>
                    ...
                    <li>
                        Cơ hội trở thành thực tập sinh chính thức tại <bold className="font-bold">Grant Thornton Vietnam</bold>
                    </li>
                    <li>
        ...
        <div ref={ref1} className={`${classes.bg} hidden z-[55] fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] pt-[3.6975vw] pb-[7.1875vw] pl-[5.9375vw] pr-[27.4vw] max-md:w-full max-md:h-full max-md:px-[6.9vw] max-md:pt-[9.3vw]`}>
            ...
            <ul className={`${classes.list} text-[#A4DEFF] flex-wrap gap-y-[1vw] gap-x-[3vw] px-[2.3125vw] list-disc mt-[1.8125vw] text-[0.875vw] overflow-hidden flex max-md:text-[2.6vw] max-md:gap-[1.6vw] max-md:mt-[5.8vw] max-md:px-[6.9vw] max-md:pl-[8vw]'`}>
                    <li>
                        <b className='font-bold'>Hiện Kim:</b> 5.000.000VNĐ
                    </li>
                    <li>
                ...
                <Image onClick={closebutton1Handler} src={closeBtn} alt='closebtn' width={30} height={30} className='absolute w-[1.875vw] right-[-15vw] max-md:top-[0%] max-md:right-0 max-md:w-[5vw] cursor-pointer'></Image>
                </div>
        </div>
        <div ref={ref2} className={`${classes.bg} z-[55] hidden fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] pt-[3.6975vw] pb-[7.1875vw] pl-[5.9375vw] pr-[27.4vw] max-md:w-full max-md:h-full max-md:px-[6.9vw] max-md:pt-[9.3vw]`}>
            ...
            <ul className={`${classes.list} text-[#A4DEFF] flex-wrap gap-y-[1vw] gap-x-[3vw] px-[2.3125vw] list-disc mt-[1.8125vw] text-[0.875vw] flex max-md:text-[3.2vw] max-md:gap-[1.6vw] max-md:mt-[5.8vw] max-md:px-[6.9vw] max-md:pl-[8vw]'`}>
                    <li>
                        <b className='font-bold'>Hiện Kim:</b> 8.000.000VNĐ
                    </li>
                    <li>
                ...
                <Image onClick={closebutton2Handler} src={closeBtn} alt='closebtn' width={30} height={30} className='absolute max-md:top-[0%] w-[1.875vw] right-[-15vw] max-md:right-0 max-md:w-[5vw] cursor-pointer'></Image>
                </div>
        </div>
        <div ref={ref3} className={`${classes.bg} z-[55] hidden fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] pt-[3.6975vw] pb-[7.1875vw] pl-[5.9375vw] pr-[27.4vw] max-md:w-full max-md:h-full max-md:px-[6.9vw] max-md:pt-[9.3vw]`}>
            ...
            <ul className={`${classes.list} text-[#A4DEFF] flex-wrap gap-y-[1vw] gap-x-[3vw] px-[2.3125vw] list-disc mt-[1.8125vw] text-[0.875vw] flex max-md:text-[3.2vw] max-md:gap-[1.6vw] max-md:mt-[5.8vw] max-md:px-[6.9vw] max-md:pl-[8vw]'`}>
                ...
                <Image onClick={closebutton3Handler} src={closeBtn} alt='closebtn' width={30} height={30} className='absolute max-md:top-[0%] w-[1.875vw] right-[-15vw] max-md:right-0 max-md:w-[5vw] cursor-pointer'></Image>
                </div>
        </div>
        <div ref={ref4} className={`${classes.bg} z-[55] hidden fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] pt-[3.6975vw] pb-[7.1875vw] pl-[5.9375vw] pr-[27.4vw] max-md:w-full max-md:h-full max-md:px-[6.9vw] max-md:pt-[9.3vw]`}>
            ...
            <li>
                ...
                <Image onClick={closebutton4Handler} src={closeBtn} alt='closebtn' width={30} height={30} className='absolute max-md:top-[0%] w-[1.875vw] right-[-15vw] max-md:right-0 max-md:w-[5vw] cursor-pointer'></Image>
                </div>
        </div>
        <div ref={ref5} className={`${classes.bg} z-[55] hidden fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] pt-[3.6975vw] pb-[7.1875vw] pl-[5.9375vw] pr-[27.4vw] max-md:w-full max-md:h-full max-md:px-[6.9vw] max-md:pt-[9.3vw]`}>
            ...
            <ul className={`${classes.list} text-[#A4DEFF] flex-wrap gap-y-[1vw] gap-x-[3vw] px-[2.3125vw] list-disc mt-[1.8125vw] text-[0.875vw] flex max-md:text-[3.2vw] max-md:gap-[1.6vw] max-md:mt-[5.8vw] max-md:px-[6.9vw] max-md:pl-[8vw]'`}>
                ...
                <Image onClick={closebutton5Handler} src={closeBtn} alt='closebtn' width={30} height={30} className='absolute max-md:top-[0%] w-[1.875vw] right-[-15vw] max-md:right-0 max-md:w-[5vw] cursor-pointer'></Image>
                </div>
        </div>
        <div ref={ref6} className={`${classes.bg} z-[55] hidden fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] pt-[3.6975vw] pb-[7.1875vw] pl-[5.9375vw] pr-[27.4vw] max-md:w-full max-md:h-full max-md:px-[6.9vw] max-md:pt-[9.3vw]`}>
            ...
            <ul className={`${classes.list} text-[#A4DEFF] flex-wrap gap-y-[1vw] gap-x-[3vw] px-[2.3125vw] list-disc mt-[1.8125vw] text-[0.875vw] flex max-md:text-[3.2vw] max-md:gap-[1.6vw] max-md:mt-[5.8vw] max-md:px-[6.9vw] max-md:pl-[8vw]'`}>
                ...
                <Image onClick={closebutton6Handler} src={closeBtn} alt='closebtn' width={30} height={30} className='absolute max-md:top-[0%] w-[1.875vw] right-[-15vw] max-md:right-0 max-md:w-[5vw] cursor-pointer'></Image>
                </div>
        </div>
    </div>
  )
