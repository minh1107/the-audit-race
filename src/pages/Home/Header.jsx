...
const Header = () => {
  ...
  return (
    <div
      id="home"
      className={`absolute z-50 top-0 header whitespace-nowrap overflow-x-hidden max-md:h-[14.6408vw] ${
        show && "max-md:bg-[#01026D]"
      } max-md:fixed`}
    >
      <div
        className=" flex text-main h-[5.94vw] items-center mx-[7.16vw] mr-[16.19vw] justify-between 
        max-md:items-center max-md:h-[14.6408vw] max-md:w-[calc(100vw-10.88vw)] max-md:mx-[5.44vw]"
      >
        <Link data-aos="fade-right" data-aos-duration="400" href={"/"}>
          <Image
            src={bigLogo}
            alt="logo"
        ...
        <ul className="flex gap-[0.25vw] mr-[1.5vw] max-md:hidden">
          <Link
            ...
            href={"/"}
            className="text-[1vw] header__item font-bold font-exoFont uppercase px-[1vw] "
          >
            Trang chủ
          </Link>
            ...
            if (index !== 0)
              return (
                <Link
                  data-aos="fade-right"
                  data-aos-duration="400"
                  onClick={pathname !== "/form-register" && handleScroll}
                  href={
                    index === 0
                      ? "/"
        ...
        <div className="max-md:flex hidden items-center gap-[4.32vw]">
          ...
          {!show && (
            <div className="hidden max-md:block" onClick={() => setShow(true)}>
              ...
              >
                <path
                  d="M3.57617 7.45117H21.5762"
                  stroke="#FFD5FE"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
                <path
                  d="M3.57617 12.4512H21.5762"
                  stroke="#FFD5FE"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
                <path
                  d="M3.57617 17.4512H21.5762"
                  stroke="#FFD5FE"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
